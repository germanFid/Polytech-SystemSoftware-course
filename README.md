...
**В результате:** Студент должен уметь просматривать и настраивать сетевые интерфейсы, понимать основы IP-адресации и маршрутизации, настраивать DNS, использовать основные сетевые утилиты, настраивать файрвол и подключаться к удаленным серверам по SSH, а также иметь базовое представление о сетевой безопасности.
